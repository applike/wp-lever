...
<div class="lever">
	 ...
	 */
	foreach ( $jobs_by_company as $department => $groups ) : ?>
        <div class="lever-department group-<?php echo str_replace( ' ', '-', strtolower( $department ) ); ?>">
            <h3 class="lever-department-title"><?php echo $department; ?></h3>
